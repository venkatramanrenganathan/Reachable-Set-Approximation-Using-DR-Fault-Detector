...
% Q_Ellipse_DR_Noise      = inv(P_Ellipse_DR_Noise);
% Q_Ellipse_Gausian_Noise = inv(P_Ellipse_Gaussian_Noise);
% 
% Q_Ellipse_DR_Attack       = inv(DR_attack_ellipse);
% Q_Ellipse_Gaussian_Attack = inv(Gaussian_attack_ellipse);
% 
% Q_Gaussian_Noise_Gaussian_Attack = (sqrt(trace(Q_Ellipse_Gausian_Noise)) + ...
%            sqrt(trace(Q_Ellipse_Gaussian_Attack)))*((Q_Ellipse_Gausian_Noise/sqrt(trace(Q_Ellipse_Gausian_Noise))) +...
%            (Q_Ellipse_Gaussian_Attack/ sqrt(trace(Q_Ellipse_Gaussian_Attack))));
% 
% Q_Gaussian_Noise_DR_Attack_Ellipsoid = (sqrt(trace(Q_Ellipse_Gausian_Noise)) + ...
%            sqrt(trace(Q_Ellipse_DR_Attack)))*((Q_Ellipse_Gausian_Noise/sqrt(trace(Q_Ellipse_Gausian_Noise))) +...
%            (Q_Ellipse_DR_Attack/ sqrt(trace(Q_Ellipse_DR_Attack))));
% 
% Q_total  = (sqrt(trace(Q_Ellipse_DR_Noise)) + ...
%            sqrt(trace(Q_Ellipse_DR_Attack)))*((Q_Ellipse_DR_Noise/sqrt(trace(Q_Ellipse_DR_Noise))) +...
%            (Q_Ellipse_DR_Attack/ sqrt(trace(Q_Ellipse_DR_Attack))));
% QQ_total = (sqrt(trace(Q_Ellipse_Gausian_Noise)) + ...
%            sqrt(trace(Q_Ellipse_Gaussian_Attack)))*((Q_Ellipse_Gausian_Noise/sqrt(trace(Q_Ellipse_Gausian_Noise))) +...
%            (Q_Ellipse_Gaussian_Attack/ sqrt(trace(Q_Ellipse_Gaussian_Attack))));
%         
% DR_P_Ellipse       = inv(Q_total);
% Gaussian_P_Ellipse = inv(QQ_total);
% 
% P_Gaussian_Noise_Gaussian_Attack     = inv(Q_Gaussian_Noise_Gaussian_Attack);
% P_Gaussian_Noise_DR_Attack_Ellipsoid = inv(Q_Gaussian_Noise_DR_Attack_Ellipsoid);
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% % Plot the Gaussian Noise and Ellipsoid
% figure;
% plot(x_gaussian_noise(1,:),x_gaussian_noise(2,:),'.k');
% grid on
% hold on;
% % Plot the Gaussian Ellipsoid
% syms xx yy
% ellipse_function  = [xx yy]*P_Ellipse_Gaussian_Noise*[xx;yy]-1;
% ellipse_function_handle = matlabFunction(ellipse_function);
% h = fimplicit(ellipse_function_handle,[-7 7 -7 7],'k','lineWidth',4);
% axis equal;
% xlabel('$x_1$', 'interpreter', 'latex');
% ylabel('$x_2$', 'interpreter', 'latex');
% uistack(h(1), 'top')
% title('Reachable States for Gaussian Noise with Chi-Squared Detector Ellipsoid','FontSize', 24)
% a = findobj(gcf, 'type', 'axes');
% h = findobj(gcf, 'type', 'line');
% set(h, 'linewidth', 4);
% set(a, 'linewidth', 4);
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% % Plot the Worst Attack & DR_Attack Ellpsoid
% figure;
% plot(x_worst_attack(1,:),x_worst_attack(2,:),'.b');
% grid on
% hold on;
% % Plot the Gaussian Total Ellipsoid
% syms xx yy
% %ellipse_function  = [xx yy]*DR_attack_ellipse*[xx;yy]-1;
% ellipse_function  = [xx yy]*Gaussian_attack_ellipse*[xx;yy]-1;
% ellipse_function_handle = matlabFunction(ellipse_function);
% h = fimplicit(ellipse_function_handle,[-7 7 -7 7],'blue','lineWidth',4);
% axis equal;
% xlabel('$x_1$', 'interpreter', 'latex');
% ylabel('$x_2$', 'interpreter', 'latex');
% uistack(h(1), 'top')
% title('Reachable States for Worst Case Attack with DR Ellipsoid','FontSize', 24)
% a = findobj(gcf, 'type', 'axes');
% h = findobj(gcf, 'type', 'line');
% set(h, 'linewidth', 4);
% set(a, 'linewidth', 4);
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% % Plot the Reachable States - TOTAL of Gaussian Noise and Worst Attack
% figure;
% plot(x_gaussian_noise_worst_attack(1,:),x_gaussian_noise_worst_attack(2,:),'.r');
% grid on
% hold on;
% % Plot the Gaussian Total Ellipsoid
% syms xx yy
% %ellipse_function  = [xx yy]*Gaussian_P_Ellipse*[xx;yy]-1;
% %ellipse_function  = [xx yy]*P_Ellipse_Gauusian_Noise*[xx;yy]-1;
% ellipse_function  = [xx yy]*P_Gaussian_Noise_Gaussian_Attack*[xx;yy]-1;
% ellipse_function_handle = matlabFunction(ellipse_function);
% h = fimplicit(ellipse_function_handle,[-7 7 -7 7],'red','lineWidth',4);
% axis equal;
% xlabel('$x_1$', 'interpreter', 'latex');
% ylabel('$x_2$', 'interpreter', 'latex');
% uistack(h(1), 'top')
% title('Reachable States of Gaussian Noise with Worst Attack & Total Chi-Squared Ellipsoid','FontSize', 24)
% a = findobj(gcf, 'type', 'axes');
% h = findobj(gcf, 'type', 'line');
% set(h, 'linewidth', 4);
% set(a, 'linewidth', 4);
...
% % Plot the Gaussian Total Ellipsoid
% syms xx yy
% ellipse_function  = [xx yy]*P_Gaussian_Noise_DR_Attack_Ellipsoid*[xx;yy]-1;
% ellipse_function_handle = matlabFunction(ellipse_function);
% h = fimplicit(ellipse_function_handle,[-7 7 -7 7],'red','lineWidth',4);
% axis equal;
% xlabel('$x_1$', 'interpreter', 'latex');
% ylabel('$x_2$', 'interpreter', 'latex');
% uistack(h(1), 'top')
% title('Reachable States of Gaussian Noise with Worst Attack & Total Bounding Ellipsoid','FontSize', 24)
% a = findobj(gcf, 'type', 'axes');
% h = findobj(gcf, 'type', 'line');
% set(h, 'linewidth', 4);
% set(a, 'linewidth', 4);
